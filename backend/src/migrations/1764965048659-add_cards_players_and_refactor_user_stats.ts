...
export class AddCardsPlayersAndRefactorUserStats1764965048659 implements MigrationInterface {
  name = "AddCardsPlayersAndRefactorUserStats1764965048659";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "position_change_card" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "storageId" uuid, CONSTRAINT "PK_61889d614a6b34fe58bd78c2589" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "card" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" "public"."card_name_enum" NOT NULL DEFAULT 'NONE', "storageId" uuid, CONSTRAINT "PK_9451069b6f1199730791a7f4ae4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "recoveryPassword"`);
    await queryRunner.query(
      `ALTER TABLE "user" ADD "recovery_password" character varying NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "user" ADD "storageId" uuid`);
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "UQ_c8cd27bd98e7b2a7c46daaf254a" UNIQUE ("storageId")`,
    );
    await queryRunner.query(`ALTER TABLE "user" ADD "statsId" uuid`);
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "UQ_79bb3ba7b87fbfdf3772c96fd87" UNIQUE ("statsId")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "position_change_card" ADD CONSTRAINT "FK_79bcac6518d10d808155f8f4c94" FOREIGN KEY ("storageId") REFERENCES "storage"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "card" ADD CONSTRAINT "FK_15fe322da9576242b9e934e59dd" FOREIGN KEY ("storageId") REFERENCES "storage"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "position_change_card" DROP CONSTRAINT "FK_79bcac6518d10d808155f8f4c94"`,
    );
    await queryRunner.query(
