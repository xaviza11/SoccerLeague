...
export class MakeUserNameUnique1766005896977 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "position_change_card" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "new_position" "public"."position_change_card_new_position_enum" NOT NULL, "storage_id" uuid NOT NULL, CONSTRAINT "PK_61889d614a6b34fe58bd78c2589" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "card" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" "public"."card_name_enum" NOT NULL DEFAULT 'NONE', "storage_id" uuid NOT NULL, CONSTRAINT "PK_9451069b6f1199730791a7f4ae4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "card" ADD CONSTRAINT "FK_75b756647a0f5175f920cdb2f98" FOREIGN KEY ("storage_id") REFERENCES "storage"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "aura" ADD CONSTRAINT "FK_c80f70cb05db523abd356164f14" FOREIGN KEY ("storage_id") REFERENCES "storage"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "market_auras" ADD CONSTRAINT "FK_73104083d878b53a2efe6494adf" FOREIGN KEY ("aura_id") REFERENCES "aura"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "market_cards" ADD CONSTRAINT "FK_8472496754172c85a0d25db5e3e" FOREIGN KEY ("card_id") REFERENCES "card"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "market_players" ADD CONSTRAINT "FK_ec99751eecf3576b493cc464f0e" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "market_position_change_cards" ADD CONSTRAINT "FK_3e3ad4ecbd169fc5e49a36e8baf" FOREIGN KEY ("position_change_card_id") REFERENCES "position_change_card"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "market_position_change_cards" DROP CONSTRAINT "FK_3e3ad4ecbd169fc5e49a36e8baf"`);
        await queryRunner.query(`ALTER TABLE "market_players" DROP CONSTRAINT "FK_ec99751eecf3576b493cc464f0e"`);
        await queryRunner.query(`ALTER TABLE "market_cards" DROP CONSTRAINT "FK_8472496754172c85a0d25db5e3e"`);
        await queryRunner.query(`ALTER TABLE "market_auras" DROP CONSTRAINT "FK_73104083d878b53a2efe6494adf"`);
