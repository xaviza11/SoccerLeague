...
describe("MarketCardsController", () => {
  let controller: MarketCardsController;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [{ provide: MarketCardsService, useValue: mockService }],
    })
      .overrideGuard(AuthGuard)
      .useValue(mockAuthGuard)
      .compile();

    controller = module.get<MarketCardsController>(MarketCardsController);
  ...
  describe("create", () => {
    it("should call service.create and return result", async () => {
      ...
      const dto = { card_id: uuid(), price: 100 };
