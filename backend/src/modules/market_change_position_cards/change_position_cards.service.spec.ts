...
describe("MarketPositionChangeCardsService", () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getRepositoryToken(MarketPositionChangeCard),
          useValue: mockMarketCardsRepo,
        },
        {
          provide: getRepositoryToken(PositionChangeCard),
          useValue: mockCardsRepo,
        },
  ...
  describe("create", () => {
    it("should create a market card successfully", async () => {
      ...
      const data = {
        position_change_card_id: cardId,
        price: 100,
        seller_id: sellerId,
      };
      const created = {
  ...
  describe("updatePrice", () => {
    it("should update price if user is seller", async () => {
      ...
      expect(mockMarketCardsRepo.save).toHaveBeenCalledWith({
        ...record,
        price: 150,
      });
    });
