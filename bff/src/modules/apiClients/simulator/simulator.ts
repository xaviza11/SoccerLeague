...
import type { GeneratePlayerResponse, GenerateGameResponse } from "./responses.js";
  ...
  public async generatePlayer(
    ...
    try {
     ...
     if (statusCode !== 200 && statusCode !== 201) {
      ...
      return response as GeneratePlayerResponse | NormalizedError;
    } catch (err: any) {
  ...
  public async simulateGame(
    ...
    try {
     ...
     if (statusCode !== 200 && statusCode !== 201) {
      ...
      return response as GenerateGameResponse | NormalizedError;
    } catch (error) {
